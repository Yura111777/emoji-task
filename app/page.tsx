...
const SortableItem = ({ entry, index }: { entry: any; index: number }) => {
    ...
    return (
        <div ref={setNodeRef} className="relative dnd-drop" style={style}>
            ...
            <button
                className="btn w-[30px]  absolute top-[15px] right-[15px] cursor-pointer hover:bg-gray-300 rounded p-1"
                onClick={() => {
                    emojiStore.removeEntry(entry.id);
                }}
            >
                <svg
                    id="Layer_1"
